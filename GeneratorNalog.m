classdef GeneratorNalog < handle
    ...
    methods(Access=private)
        ...
        function check(obj)
            ...
            if obj.relativna_toleranca > 1e-2, warning(['Relativna toleranca %g je precej visoka '...
                    '- tudi kakšen napačen rezultat bi lahko bil sprejet.'], obj.relativna_toleranca); end
